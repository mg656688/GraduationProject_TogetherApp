...
class AddToGardenPage extends StatefulWidget {
  final String prediction;

  const AddToGardenPage(this.prediction, {Key? key});

  @override
  _AddToGardenPageState createState() => _AddToGardenPageState();
}

class _AddToGardenPageState extends State<AddToGardenPage> {
